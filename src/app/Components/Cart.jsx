...
function Cart() {
  ...
  const handleUpdateQuantity = (id, quantity) => {
    dispatch(updateCartItemQuantity(id, parseInt(quantity, 10) || 0));
  };
  ...
  return (
    <div className="cart p-2 w-95 mx-auto my-12 sm:my-5 bg-white">
      ...
      <div className="cart-final flex flex-col gap-5 lg:flex-row   mt-10 align-middle">
        <div className="cartfinal-child1 lg:w-1/2 text-center">
          <input
            ...
            className="p-2 my-5"
          />
          <button className="dis p-2 px-4 bg-[#00b4d8] border border-[#00b4d8] text-white rounded-md">
            Apply Discount
          </button>
        </div>
        <div className="cartfinal-child lg:w-1/2">
          <div className="switch grid lg:grid-cols-3 gap-4">
            <button
              ...
              className="down p-3 px-4 bg-[#00b4d8] border border-[#00b4d8] text-white rounded-md"
            >
              Download Quotation
            </button>
            <button className="share p-3 px-4 bg-[#00b4d8] border border-[#00b4d8] text-white rounded-md">
              Share Cart
            </button>
            <button
              onClick={handleUpdateCart}
              className="update p-3 px-4 bg-[#00b4d8] border border-[#00b4d8] text-white rounded-md"
            >
          ...
          <div className="summery border border-gray-300 p-4 grid gap-4 mt-10">
            ...
            <div className="proceed mt-5">
              <a to="/checkout">
                <button className="p-3 px-4 bg-[#00b4d8] border border-[#00b4d8] text-white rounded-md w-full">
                  Proceed to Checkout
                </button>
              </a>
            </div>
      ...
      <div
        className={`${popup} fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 z-50`}
      >
        <div className="download  px-10 py-5 bg-white w-96  transform -translate-x-1/2 -translate-y-1/2 absolute top-1/2 left-1/2 rounded-2xl z-20">
          <p
            ...
            className="close text-right text-2xl text-gray-500"
          >
            X
          </p>
